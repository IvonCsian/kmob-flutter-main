                    ...
                    child: Container(
                      ...
                      child: new Column(
                        children: <Widget>[
                          ...
                          badge.Badge(
                            badgeColor: couponModel.splittable.toString() == "0"
                                ? Colors.blue[600]
                                : Colors.green[600],
                          ...
                          badge.Badge(
                            badgeColor: couponModel.idStatus.toString() == "2"
                                ? Colors.blue[600]
                                : (couponModel.idStatus.toString() == "3" ||
                                        couponModel.idStatus.toString() == "4")
                                    ? Colors.yellow[600]
                            ...
                            toAnimate: false,
                            badgeContent: Text(
                                couponModel.voucherstatus.toString(),
                                style: new TextStyle(
                                    fontFamily: "WorkSansMedium",
                                    fontSize: 15.0,
                                    color: Colors.white)),
