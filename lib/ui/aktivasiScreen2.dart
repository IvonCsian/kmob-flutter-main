...
import 'package:kmob/ui/AktivasiScreen3.dart';
import 'package:kmob/utils/constant.dart';
import 'package:http/http.dart' as http;
import 'package:progress_hud/progress_hud.dart';

class AktivasiScreen2 extends StatefulWidget {
  ...
  const AktivasiScreen2(
      ...
      : super(key: key);
  @override
  _AktivasiScreen2State createState() => _AktivasiScreen2State();
}

class _AktivasiScreen2State extends State<AktivasiScreen2> {
  bool _loading = false;
            ...
            child: Padding(
                ...
                child: Column(children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      Text("Upload KTP dan ID Karyawan",
                          style: TextStyle(
                  ...
                  ElevatedButton(
                    ...
                    child: new Text('Pilih foto KTP dan ID Karyawan'),
                  )
                ]))));
  }
  ...
  Future<void> retrieveLostData() async {
    ...
    if (File(response.file.path) != null) {
      setState(() {
        _imageFile = File(File(response.file.path).path);
      });
    } else {
  ...
  Future _getImage(String mode) async {
    try {
      ...
      setState(() {
        ...
        _filename = "verifikasi_ktpidcard_" + widget.nak + "_" + widget.nik;
      });
    } catch (e) {
      _pickImageError = e;
    }
      ...
      return Column(
        children: <Widget>[
          ...
          ElevatedButton(
            ...
            ,
            child: new Text(
              'Upload foto KTP dan ID Karyawan',
  ...
  Future<void> _uploadData() async {
    ...
    Navigator.push(
      _context,
      MaterialPageRoute(
          builder: (context) => AktivasiScreen3(
